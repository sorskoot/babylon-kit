import type {WebXRAbstractMotionController, WebXRDefaultExperience} from '@babylonjs/core';
import {GamepadManager, KeyboardEventTypes, Observable, PointerEventTypes, Scene} from '@babylonjs/core';
...
export class InputManager {
     ...
     */
    public isMouseButtonHeld(button: MouseButton): boolean {
     ...
     * @returns `true` if the button is currently held.
     */
    public isGamepadButtonHeld(button: GamepadButton): boolean {
     ...
     * @returns `true` if the button was pressed this frame.
     */
    public isGamepadButtonPressed(button: GamepadButton): boolean {
     ...
     * @returns `true` if the button was released this frame.
     */
    public isGamepadButtonReleased(button: GamepadButton): boolean {
